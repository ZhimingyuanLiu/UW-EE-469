...
not #50 NOT(cntrli, cntrl[0]);
and #50 AND1(temp1,cntrli,Cout_a[63]);
and #50 AND2(temp2,cntrl[0],Cout_s[63]);
or #50 OR1(Cout[0], temp1, temp2);

and #50 AND3(temp3,cntrli,Cout_a[62]);
and #50 AND4(temp4,cntrl[0],Cout_s[62]);
or #50 OR2(Cout[1], temp3, temp4);

xor #50 overFLOW(overflow, Cout[0], Cout[1]);
